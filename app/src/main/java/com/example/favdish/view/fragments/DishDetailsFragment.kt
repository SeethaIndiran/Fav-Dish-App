    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        args.let {
            ...
            if(args.dishDetails.favouriteDish){
                mBinding!!.ivFavouriteDish.setImageDrawable(ContextCompat.getDrawable(
                    requireActivity(),R.drawable.ic_favorite_selected
                ))

            }else{
                mBinding!!.ivFavouriteDish.setImageDrawable(ContextCompat.getDrawable(
                    requireActivity(),R.drawable.ic_favourite_unselected
                ))
            }
        ...
        mBinding!!.ivFavouriteDish.setOnClickListener {
            ...
            if(args.dishDetails.favouriteDish){
                ...
                Toast.makeText(requireActivity(),resources.getString(R.string.msg_added_to_favourites),
                    Toast.LENGTH_SHORT).show()
            }else{
                mBinding!!.ivFavouriteDish.setImageDrawable(ContextCompat.getDrawable(
                    requireActivity(),R.drawable.ic_favourite_unselected
                ))
                Toast.makeText(requireActivity(),resources.getString(R.string.msg_removed_from_favourites),
                    Toast.LENGTH_SHORT).show()
            }
        }
    }
